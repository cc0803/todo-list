...
addCategoryButton.addEventListener("click", () => {
  ...
  document
    .querySelector(".overlay .createCategory")
...
const submitNewTodoButton = document.querySelector(
  ".overlayTwo .createTodo button"
);
...
submitNewTodoButton.addEventListener("click", (e) => {
  if (validateForm()) {
    ...
    // UI Relevent Aspects
    clearInputFields();
    const formForCreatingNewTodo = document.querySelector(
